      ...
      <section className="inner-hero">
        <Container>
          <SectionTitle
            ...
            description="В этом разделе представлена информация о компании, её опыте, принципах работы и подходе к взаимодействию с клиентами."
          />
        </Container>
      </section>
      ...
      <section className="section section--gray">
        <Container>
          <SectionTitle
            ...
            description="Мы строим работу с клиентами на принципах прозрачности, ответственности, конфиденциальности и практической пользы."
          />
      ...
      <section className="section">
        <Container>
          <SectionTitle
            ...
            description="Если вы хотите обсудить сотрудничество или получить консультацию, оставьте заявку, и специалист компании свяжется с вами."
          />
