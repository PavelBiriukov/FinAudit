      ...
      <section className="section">
        <Container>
          <SectionTitle
            ...
            description="На главной странице представлены ключевые направления деятельности компании. Подробное описание всех услуг доступно в отдельном разделе."
          />
      ...
      <section className="section">
        <Container>
          <SectionTitle
            ...
            description="Заполните форму, и специалист компании свяжется с вами для обсуждения задачи и подбора подходящего решения."
          />
